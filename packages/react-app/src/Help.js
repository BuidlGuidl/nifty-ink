...
const addXDAItoMetamask = async props => {
  if (
    props.injectedProvider.connection &&
    props.injectedProvider.connection.url === "metamask"
  ) {
    try {
    ...
    message.error(
      "MetaMask was not detected. Make sure MetaMask is installed and connected!"
    );
  }
};
...
export default function Help(props) {
  return (
    <div>
      ...
      >
        <p>
          If you prefer to use <a href="https://metamask.io">MetaMask</a>{" "}
          instead of burner wallet, simply click on the button below to add xDAI
          chain as custom network in MetaMask.
        </p>
        <p>
          To add xDAI chain manually to MetaMask instead, please follow{" "}
          <a href="https://www.xdaichain.com/for-users/wallets/metamask/metamask-setup">
            manual instuctions
          </a>{" "}
          on xDAI chain official website.
        </p>
        <p>
          <b>Note: </b>Make sure MetaMask is installed and connected first.
        </p>
        <Button
          type="primary"
          size="large"
      ...
      <p>
        If you are not using MetaMask, you can export your burner wallet private
        key:{" "}
      </p>
      <ul>
      ...
      <Row>
        ...
        <p>
          The following keyboard shortcuts are available while drawing on
          canvas:
        </p>
        <Table
          columns={[
