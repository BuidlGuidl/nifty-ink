...
import { BrushControls } from "./create/_components/BrushControls";
import { CanvasControls } from "./create/_components/CanvasControls";
import { ColorPicker } from "./create/_components/ColorPicker";
import { DraftManager } from "./create/_components/DraftManager";
import { useHotkeyBindings } from "./create/_hooks/useHotkeyBindings";
...
const CreateInk = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      compressionWorker = new Worker(new URL("./create/compressionWorker.ts", import.meta.url));
    }
