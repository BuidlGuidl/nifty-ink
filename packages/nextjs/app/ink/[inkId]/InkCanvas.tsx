    ...
    >
      ...
      {inkJson.image && (
        <Descriptions.Item label="Image">
          {
            <a
              href={inkJson.image.replace("https://ipfs.io/ipfs/", "https://niftyink.bgipfs.com/ipfs/")}
              target="_blank"
            >
              {inkJson.image}
            </a>
            ...
            >
              {inkJson.image ? (
                <object
                  ...
                  data={inkJson.image.replace("https://ipfs.io/ipfs/", "https://niftyink.bgipfs.com/ipfs/")}
                >
